...
// RevenueCat secret API key (sk_...). Lets the backend verify a subscription
// directly with RevenueCat's REST API right after purchase, so premium unlocks
// instantly instead of waiting on the async webhook. Optional — when empty, the
// synchronous sync no-ops and the webhook remains the sole source of truth.
